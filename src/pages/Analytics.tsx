    ...
    <DashboardLayout>
      <div className="p-6 lg:p-8 max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <StatCard title={t("analytics_completion_rate")} value="74%" change="+8%" changeType="positive" icon={Target} color="primary" />
          <StatCard title={t("analytics_avg_time")} value="4h 32m" change="-12min" changeType="positive" icon={Clock} color="accent" />
          <StatCard title={t("analytics_active_users")} value={178} change="+22" changeType="positive" icon={Users} color="info" />
          <StatCard title={t("analytics_global_progress")} value="+15%" change="vs trimestre" changeType="positive" icon={TrendingUp} color="success" />
        </div>
        ...
        >
          <h2 className="text-lg font-semibold text-foreground mb-5">{t("analytics_service_perf")}</h2>
              ...
              >
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-1">
                    <span className="text-sm text-muted-foreground">{t("analytics_completion")}</span>
                ...
                <div className="text-right w-20">
                  ...
                  <div className="text-xs text-muted-foreground">{t("analytics_avg_score")}</div>
                </div>
                <div className="text-right w-16">
                  <div className="text-sm font-bold text-foreground">{s.activeUsers}</div>
                  <div className="text-xs text-muted-foreground">{t("analytics_active")}</div>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        <motion.div
          ...
          className="glass-card rounded-xl p-6"
        >
          <h2 className="text-lg font-semibold text-foreground mb-3">{t("analytics_skills_map")}</h2>
          <p className="text-sm text-muted-foreground mb-5">{t("analytics_skills_desc")}</p>
