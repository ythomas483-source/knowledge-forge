...
const formations = [
  { id: 1, title: "Sécurité Réseau – Interne", service: "IT", modules: 4, participants: 32, progress: 78, status: "active", generatedAt: "12 jan 2025", description: "Parcours généré automatiquement à partir de la documentation réseau interne." },
  { id: 2, title: "Onboarding Commercial Q1", service: "Sales", modules: 6, participants: 18, progress: 45, status: "active", generatedAt: "5 jan 2025", description: "Formation d'intégration pour les nouveaux commerciaux, basée sur les process de vente." },
  { id: 3, title: "RGPD & Conformité 2024", service: "Compliance", modules: 3, participants: 120, progress: 92, status: "active", generatedAt: "20 déc 2024", description: "Formation obligatoire sur la protection des données et la conformité réglementaire." },
  { id: 4, title: "Process RH – Recrutement", service: "RH", modules: 5, participants: 8, progress: 34, status: "draft", generatedAt: "8 jan 2025", description: "Guide complet des procédures de recrutement interne, de la candidature à l'intégration." },
  { id: 5, title: "Architecture Cloud AWS", service: "IT", modules: 8, participants: 15, progress: 12, status: "draft", generatedAt: "15 jan 2025", description: "Bonnes pratiques d'architecture cloud et migration des services internes." },
];
...
const Formations = () => {
  ...
  const visibleFormations = isGuest
    ? formations.filter((f) => f.status === "active")
    : formations;
